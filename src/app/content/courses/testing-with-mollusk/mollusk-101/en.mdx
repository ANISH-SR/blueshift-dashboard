...
program_account_account.owner = ID; // The program that owns the account
```

For accounts with data, you can initialize them like this:
...
> When creating accounts, you can use `Account::default()` as a starting point and then set the specific fields you need.
